        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Depuis notre création, nous nous efforçons de redéfinir l&lsquo;excellence dans la mode de luxe.
            </p>
          </div>
          ...
          <div className="space-y-24">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <p className="text-gray-600">
                  LUXE a été fondée avec une vision claire : créer une marque de mode qui allie l&lsquo;élégance intemporelle
                  à l&lsquo;innovation contemporaine. Notre voyage a commencé dans un petit atelier à Paris.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8">
              ...
              <div className="w-full md:w-1/2 space-y-4">
                <h2 className="text-3xl font-bold text-gray-900">2015 - L&lsquo;Expansion</h2>
                <p className="text-gray-600">
                  Après des années de croissance constante, nous avons étendu notre présence à l&lsquo;international,
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="w-full md:w-1/2 space-y-4">
                <h2 className="text-3xl font-bold text-gray-900">2020 - L&lsquo;Innovation</h2>
                <p className="text-gray-600">
                  Aujourd&lsquo;hui, LUXE est à l&lsquo;avant-garde de l&lsquo;innovation durable dans la mode de luxe,
          ...
          <div className="mt-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">Nous nous efforçons d&lsquo;atteindre l&lsquo;excellence dans chaque détail.</p>
              </div>
              <div className="text-center space-y-4">
                <div className="w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center mx-auto">
                  <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
