            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Votre colis est confié à notre partenaire de livraison pour l&lsquo;acheminement.</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 bg-gray-900 rounded-full p-2 mr-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Votre colis est livré à l&lsquo;adresse indiquée ou disponible en boutique pour le retrait.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-gray-600">Les délais varient selon l&lsquo;option choisie : 3-5 jours pour la livraison standard, 1-2 jours pour l&lsquo;express, et 5-10 jours pour l&lsquo;international.</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4">
