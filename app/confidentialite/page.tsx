        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <div className="prose prose-lg text-gray-600">
                <p>Nous pouvons collecter les types d&lsquo;informations suivants :</p>
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  ...
                  <li>
                    ...
                    historique d&lsquo;achats, préférences.
                  </li>
                  <li>
            ...
            <section>
              ...
              <div className="prose prose-lg text-gray-600">
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  ...
                  <li>Les autorités légales si la loi l&lsquo;exige</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="prose prose-lg text-gray-600">
                <p>
                  ...
                  vos données personnelles contre la perte, l&lsquo;accès non autorisé, la divulgation ou la destruction.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="prose prose-lg text-gray-600">
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  <li>Droit d&lsquo;accès à vos données personnelles</li>
                  <li>Droit de rectification des données inexactes</li>
                  <li>Droit à l&lsquo;effacement (&quot;droit à l&apos;oubli&quot;)</li>
                  <li>Droit à la limitation du traitement</li>
                  <li>Droit à la portabilité des données</li>
                  <li>Droit d&lsquo;opposition au traitement</li>
                  <li>Droit de retirer votre consentement à tout moment</li>
                </ul>
                <p className="mt-4">
                  Pour exercer ces droits, contactez-nous à l&lsquo;adresse : privacy@luxe.com
                </p>
              </div>
            </section>
