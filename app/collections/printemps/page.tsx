        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Notre collection printemps célèbre les couleurs vives, les motifs floraux et les tissus légers.
              Découvrez des pièces élégantes qui capturent l&lsquo;essence du renouveau saisonnier.
            </p>
          </div>
